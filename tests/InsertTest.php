...
class InsertTest extends TestCase
{
    ...
    public function insert()
    {
        ...
        $insertOperation->execute($this->getConnection(), new FlatXmlDataSet(dirname(__FILE__).'/_fixtures/InsertInput.xml'));

        $this->assertDataSetsEqual(new FlatXmlDataSet(dirname(__FILE__).'/_fixtures/InsertResult.xml'), $this->getConnection()->createDataSet());
    }
}
